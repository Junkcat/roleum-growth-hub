...
const targetAudience = [
  ...
  "Продуктовые команды в ИТ бизнесе",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-n-600 max-w-4xl mx-auto leading-relaxed">
              Roleum — AI-платформа и набор методик Центра экспертизы 
              для развития компетенций цифровых ролей в крупных компаниях. 
              Мы объединяем AI-персонализацию, контент, практики, оценку, сообщество и дашборды в единую систему.
            </p>
          </div>
